...
<body>
	...
	<div class="contact-clean">
		...
		$retval = mysql_query( $sql, $con );
							   ...
							   if(! $retval ) {
								...
								while($row = mysql_fetch_array($retval, MYSQL_ASSOC)) 
									...
									echo "</select>
										<input type='submit' value='Change status to Completed' name='update'></form>
										";
		...
		<?php 
			...
			{
				$id=$_POST['id'];
				$sql="UPDATE `requests` SET `status`='Completed' WHERE requestid='".$id."'";
				echo $sql;
							...
							echo "<script> window.location.assign('viewrequest.php'); </script>";
